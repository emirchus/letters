...
export default function HomePage() {
  return (
    <div className="min-h-screen w-full">
      <header className="container flex h-14 items-center px-4 lg:px-6 justify-center">
            ...
            <div className="relative grid h-full w-full grid-cols-1 items-center gap-x-8 overflow-hidden border-x p-6 lg:grid-cols-2 lg:px-12">
              ...
              <div className="">
                <div className="bg-background/10 relative mb-4 min-h-[28vh] flex-1 rounded-lg border p-4 shadow-lg">
                  ...
                  <div className="to-accent/40 pointer-events-none absolute inset-0 z-50 bg-linear-to-b from-transparent" />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className="hover:bg-secondary/20 flex flex-col items-center justify-center gap-y-2 border-b px-4 py-8 transition-colors last:border-b-0 lg:border-r md:nth-[2n+1]:border-r lg:nth-[3n]:border-r-0 lg:nth-[n+4]:border-b-0 md:nth-[n+5]:border-b-0">
              <div className="flex flex-col items-center gap-y-2">
                ...
                <h2 className="text-card-foreground text-center text-xl font-medium text-balance">Simple Workflows</h2>
              </div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="w-full max-w-sm space-y-2">
                <form className="flex space-x-2">
                  <Input className="text-primary max-w-lg flex-1" placeholder="Enter your email" type="email" />
